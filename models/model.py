...
def create_model(checkpoint_path: str = None, device: str = "cpu") -> BaselineSemiconNet:
    """
    Factory helper to instantiate and load the trained SiliconVision model.
    """
    dev = torch.device(device)
    model = BaselineSemiconNet(in_channels=1, out_channels=1, width=32, scale_factor=2).to(dev)
